       ...
       <tr>
         ...
         <td><%=entity.getEmail() %></td>
           <td><%=entity.getSalutation() %></td>
             ...
             <td>
             	<img src="${pageContext.request.contextPath}/displayImage?uid=<%=entity.getuID() %>"  style="height: 100px; width: 120px;">
             				
			<a href="selectSignupForImage?sid=<%=entity.getuID() %>">
                 		<img src="${pageContext.request.contextPath}/img/content.png"  style="height: 40px;">
                </a> 
             </td>
